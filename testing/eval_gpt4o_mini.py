...
Usage:
    OPENAI_API_KEY=sk-... python testing/eval_gpt4o_mini.py \
        --csv  genomorph/dataset/global_stage1_anon_genes_mol_keep_chr.csv \
        --out  testing/logs/gpt4o_mini_results.csv \
        --splits test val
...
# ── Extraction (same logic as genomorph/dna_modules/nucleotide_module.py) ─────
...
def parse_args():
    ...
    p.add_argument("--out",     default="testing/logs/gpt4o_mini_results.csv",
    ...
    p.add_argument("--rpm_limit",    type=int, default=500,
                   help="Requests per minute limit to avoid rate errors (default: 500)")
