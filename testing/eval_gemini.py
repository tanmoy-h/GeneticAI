...
Usage:
    GEMINI_API_KEY=AIza... python testing/eval_gemini.py \
        --csv  genomorph/dataset/global_stage1_anon_genes_mol_keep_chr.csv \
        --out  testing/logs/gemini_results.csv \
        --splits test val
...
def parse_args():
    ...
    p.add_argument("--out",     default="testing/logs/gemini_results.csv",
    ...
    for idx, row in enumerate(records):
        ...
        try:
            ...
            try:
                ...
                # Response blocked by safety filters — treat as empty
                raw = ""
