...
| GenoMorph: GRPO, fixed θ_low=0 | `train/train_06_stage3_grpo.sh` | 1-dir: `THETA_LOW=0 CKPT=$CK/train_06_stage3_grpo/checkpoint-N bash test/test_06b_eval_stage3.sh`<br>bi-dir: same + `test/test_06b_eval_stage3_final.sh` | `train/anon/train_06_stage3_grpo.sh` | 1-dir: `THETA_LOW=0 CKPT=$CK/train_06_stage3_grpo_anon/checkpoint-N bash test/anon/test_06b_eval_stage3.sh`<br>bi-dir: same + `test/anon/test_06b_eval_stage3_final.sh` |
| GenoMorph: GRPO, fixed θ_low=1 | `train/train_06_stage3_grpo.sh` | 1-dir: `THETA_LOW=1 CKPT=$CK/train_06_stage3_grpo/checkpoint-N bash test/test_06b_eval_stage3.sh`<br>bi-dir: same + `test/test_06b_eval_stage3_final.sh` | `train/anon/train_06_stage3_grpo.sh` | 1-dir: `THETA_LOW=1 CKPT=$CK/train_06_stage3_grpo_anon/checkpoint-N bash test/anon/test_06b_eval_stage3.sh`<br>bi-dir: same + `test/anon/test_06b_eval_stage3_final.sh` |
