...
## Requires a completed SFT checkpoint from sh_train_bioreason_sft_anon.sh.
##
## Usage:
##   bash src/scripts/anon/sh_train_bioreason_grpo_anon.sh [gpu_id]
##   SFT_CKPT=/path/to/sft.ckpt bash src/scripts/anon/sh_train_bioreason_grpo_anon.sh
##   sbatch src/scripts/anon/sh_train_bioreason_grpo_anon.sh
