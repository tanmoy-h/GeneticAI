#!/bin/bash
#SBATCH --job-name=train_bioreason
...
##
## Usage:
##   bash Source/tests/sh_train_bioreason.sh [gpu_id]
##   CKPT_PATH=checkpoints/.../last.ckpt bash Source/tests/sh_train_bioreason.sh   # resume
##   sbatch Source/tests/sh_train_bioreason.sh
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-/scratch/tanmoyh_iitp/GenoMorph/checkpoints/bioreason}
CKPT_PATH=${CKPT_PATH:-}
## ─────────────────────────────────────────────────────────────────────────────
