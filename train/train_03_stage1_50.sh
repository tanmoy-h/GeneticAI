...
KEGG_CSV=${KEGG_CSV:-}
OUTPUT_DIR=${OUTPUT_DIR:-/scratch/tanmoyh_iitp/GenoMorph/checkpoints/train_03_stage1_50}
...
if [ -z "${STAGE1_CKPT:-}" ]; then
    ...
    echo "Usage: STAGE1_CKPT=<path|hf://org/repo/file> bash train/train_03_stage1_50.sh [gpu_id]"
    exit 1
fi
